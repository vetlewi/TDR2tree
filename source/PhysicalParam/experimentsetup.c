...
DetectorInfo_t pDetector[] =
{
    ...
    {352, f100MHz, de_sect, 14, 0},
    {353, f100MHz, de_sect, 12, 0},
    {354, f100MHz, de_sect, 10, 0},
    {355, f100MHz, de_sect, 8, 0},
    {356, f100MHz, de_sect, 6, 0},
    {357, f100MHz, de_sect, 4, 0},
    {358, f100MHz, de_sect, 2, 0},
    {359, f100MHz, de_sect, 0, 0},
    {360, f100MHz, de_sect, 1, 0},
    {361, f100MHz, de_sect, 3, 0},
    {362, f100MHz, de_sect, 5, 0},
    {363, f100MHz, de_sect, 7, 0},
    {364, f100MHz, de_sect, 9, 0},
    {365, f100MHz, de_sect, 11, 0},
    {366, f100MHz, de_sect, 13, 0},
    {367, f100MHz, de_sect, 15, 0},
    ...
    {416, f100MHz, de_ring, 46, 0},
    {417, f100MHz, de_ring, 44, 0},
    {418, f100MHz, de_ring, 42, 0},
    {419, f100MHz, de_ring, 40, 0},
    {420, f100MHz, de_ring, 38, 0},
    {421, f100MHz, de_ring, 36, 0},
    {422, f100MHz, de_ring, 34, 0},
    {423, f100MHz, de_ring, 32, 0},
    {424, f100MHz, de_ring, 30, 0},
    {425, f100MHz, de_ring, 28, 0},
    {426, f100MHz, de_ring, 26, 0},
    {427, f100MHz, de_ring, 24, 0},
    {428, f100MHz, de_ring, 22, 0},
    {429, f100MHz, de_ring, 20, 0},
    {430, f100MHz, de_ring, 18, 0},
    {431, f100MHz, de_ring, 16, 0},
    ...
    {448, f100MHz, de_ring, 47, 0},
    {449, f100MHz, de_ring, 45, 0},
    {450, f100MHz, de_ring, 43, 0},
    {451, f100MHz, de_ring, 41, 0},
    {452, f100MHz, de_ring, 39, 0},
    {453, f100MHz, de_ring, 37, 0},
    {454, f100MHz, de_ring, 35, 0},
    {455, f100MHz, de_ring, 33, 0},
    {456, f100MHz, de_ring, 31, 0},
    {457, f100MHz, de_ring, 29, 0},
    {458, f100MHz, de_ring, 27, 0},
    {459, f100MHz, de_ring, 25, 0},
    {460, f100MHz, de_ring, 23, 0},
    {461, f100MHz, de_ring, 21, 0},
    {462, f100MHz, de_ring, 19, 0},
    {463, f100MHz, de_ring, 17, 0},
    ...
    /*{480, f100MHz, eDet, 14, 0},
    {481, f100MHz, eDet, 12, 0},
    {482, f100MHz, eDet, 10, 0},
    {483, f100MHz, eDet, 8, 0},
    {484, f100MHz, eDet, 6, 0},
    {485, f100MHz, eDet, 4, 0},
    {486, f100MHz, eDet, 2, 0},
    {487, f100MHz, eDet, 0, 0},
    {488, f100MHz, eDet, 1, 0},
    {489, f100MHz, eDet, 3, 0},
    {490, f100MHz, eDet, 5, 0},
    {491, f100MHz, eDet, 7, 0},
    {492, f100MHz, eDet, 9, 0},
    {493, f100MHz, eDet, 11, 0},
    {494, f100MHz, eDet, 13, 0},
    {495, f100MHz, eDet, 15, 0},*/
